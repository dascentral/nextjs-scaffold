...
* [theodorusclarence/ts-nextjs-tailwind-starter](https://github.com/theodorusclarence/ts-nextjs-tailwind-starter) — Another GitHub template repository that has significantly more happening that what I've gotten to here
* [philipbeel/example-nextjs-turborepo-storybook-tailwind](https://github.com/philipbeel/example-nextjs-turborepo-storybook-tailwind) — A monorepo approach
